...
presence_only = {
    ...
    'EnvironmentalValues':{
        'not_cube': [
            'EnvironmentalValues/EnvironmentalValues.zip'],
        'cube': []
    },
    'climate': {
        'not_cube': [
...
presence_absence = {
    'BioclimTimeSeries':{
        'not_cube': [
            ...
            'BioclimTimeSeries/values/GLC25-PA-test-bioclimatic_monthly.csv'],
        'cube': [
            'BioclimTimeSeries/cubes/GLC25_PA_test_bioclimatic_monthly.zip',
            'BioclimTimeSeries/cubes/GLC25_PA_train_bioclimatic_monthly.zip'
        ]
    },
    'EnvironmentalValues':{
        'not_cube': [],
...
metadata = {
    'po': [
        'PresenceOnlyOccurrences/GLC25_PO_metadata_train.csv'
        ],
    'pa': [
        'PresenceAbsenceSurveys/GLC25_PA_metadata_test.csv',
        'PresenceAbsenceSurveys/GLC25_PA_metadata_train.csv'
    ]
}
repository = 'https://lab.plantnet.org/seafile/d/979791609d0e4016a68a'
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=('GeoLifeCLEF 2025 file downloader. '
